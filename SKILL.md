...
description: 通用学术论文专业润色能力：对期刊/学位论文段落与全文做标准化润色，遵循25条学术写作规范，优化逻辑、术语、数据表述，不篡改数据、公式与核心观点。触发词：论文润色、学术段落优化、术语统一、数据表述规范、试验描述规范。
---
...
2. `core/rule_base.md` —— 25 条学术写作规则库（结构/逻辑/术语/数据/公式/层级角色），润色时逐条校验
